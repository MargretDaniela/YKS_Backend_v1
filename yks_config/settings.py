...
#  SECURITY
# ======================================================================
SECRET_KEY = os.environ.get('SECRET_KEY', 'youthkey-series-django-secret-key-2026-very-long-string')
DEBUG = os.environ.get('DEBUG', 'False') == 'True'

ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'yks-backend-v1.onrender.com,127.0.0.1,localhost').split(',')
...
JAZZMIN_SETTINGS = {
    ...
    "order_with_respect_to": [
        "accounts", "courses", "mentorship",
        "attendance", "payments", "certificates",
        "jobs", "notifications", "pages",
    ],
    "hide_apps":   [],
    "hide_models": [
        "pages.homebanner", "pages.homefeaturedcourse", "pages.homesection",
...
EMAIL_PORT          = 587
EMAIL_USE_TLS       = True
EMAIL_HOST_USER     = os.environ.get('EMAIL_HOST_USER', 'danielamargret6@gmail.com')
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', 'mxwt jrmk fcvm sroz')
DEFAULT_FROM_EMAIL  = f'Youth KEY Series <{EMAIL_HOST_USER}>'